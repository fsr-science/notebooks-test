# CHAPTER 8 — PRACTICE QUESTION BANK

### Mechanical Properties of Solids

#### 80+ Questions | Board · NEET · JEE Layered
...
**Q1.** The property of a body by virtue of which it tends to regain its original shape and size when the applied force is removed is called:
...
**Q3.** Shearing strain is defined as:
...
**Q4.** Which of the following is NOT a type of stress?
...
**Q5.** Hooke's law states that, for small deformations:
...
**Q6.** Bulk modulus is applicable to:
...
**Q7.** The dimensional formula of Young's modulus is:
...
**Q8.** A material that returns to its original shape after the deforming force is removed, even after very large deformation, but does NOT obey Hooke's law, is called:
...
**Q9.** Which of the following materials has the highest Young's modulus?
...
**Q10.** The elastic limit of a material is the stress at which:

* (a) The material begins to obey Hooke's law
* (b) The material fractures
* (c) The material begins to show permanent deformation
* (d) Stress equals strain

---

**Q11.** On a stress-strain curve for a metal, the point of maximum stress is called:
...
**Q12.** The reciprocal of bulk modulus is called:
...
**Q13.** A solid is more elastic than a liquid because:

* (a) Liquids are heavier
* (b) Atoms in solids are tightly packed, resisting deformation more effectively
* (c) Solids are harder
* (d) Solids have higher density
...
* (c) Restoring force per unit area
* (d) Energy stored per unit volume

---

**Q15.** Which type of stress is possible only in solids?
...
| 10 | (c) | Elastic limit = stress beyond which deformation becomes plastic (permanent) |
| 11 | (c) | Ultimate tensile strength (point D) is the maximum stress before fracture |
...
**Q16.** A wire of length L and cross-sectional area A has Young's modulus Y. It is stretched by a force F. The elongation ΔL is:
...
**Q17.** Two wires of the same material have lengths L and 2L, and areas of cross-section 2A and A respectively. The ratio of their elongations under the same applied force is:
...
**Q18.** For a metallic wire, the region in the stress-strain curve where the material can still return to its original shape but stress is NOT proportional to strain is:

* (a) O to A (proportional limit)
* (b) A to B (between proportional limit and elastic limit)
* (c) B to D (plastic region)
* (d) D to E (fracture region)

---

**Q19.** A wire stretches by x under a certain load. If the length is doubled and the cross-sectional radius is also doubled, the elongation under the same load will be:
...
**Q20.** The elastic potential energy stored per unit volume of a stretched wire is:
...
**Q21.** The shear modulus of a material is 84 × 10⁹ N m⁻². A force of 8.4 × 10⁴ N is applied tangentially to a face of area 0.1 m². The shearing strain produced is:
...
**Q22.** Gases are about how many times more compressible than solids?
...
**Q23.** Poisson's ratio for a material is 0.3. If a wire of this material is stretched such that its length increases by 1%, the fractional decrease in its diameter is:
...
**Q26.** The reason ropes in cranes are made of many braided thin wires rather than a single thick wire is:

* (a) Thin wires are cheaper
* (b) Braided wires offer greater flexibility while maintaining strength
* (c) Thin wires have greater Young's modulus
* (d) The rules require it by law

---

**Q27.** The pressure required to reduce the volume of water by 1% is: (Bulk modulus of water = 2.2 × 10⁹ N m⁻²)
...
**Q28.** On the stress-strain curve, the slope of the linear region (O to A) represents:
...
**Q29.** Which of the following is correct about shear modulus?

* (a) G = Y for all materials
* (b) G > Y for all materials
* (c) G ≈ Y/3 for most metals
* (d) G applies to liquids as well as solids

---

**Q30.** The elastic potential energy stored in a steel wire of volume V, Young's modulus Y, stretched by strain ε is:
...
| 19 | (a) | ΔL = FL/(AY); new ΔL = F(2L)/((π(2r)²)Y) = 2FL/(4πr²Y) = x/2 |
| 20 | (b) | u = ½σε (standard result for elastic PE per unit volume) |
| 21 | (a) | Shearing strain = (F/A)/G = (8.4×10⁴/0.1)/(84×10⁹) = 8.4×10⁵/84×10⁹ = 10⁻⁵ |
...
| 30 | (b) | u = ½Yε² per unit volume; Total PE = ½Yε² × V |
...
**Q31.** Two wires A and B of equal lengths are made of the same material. Wire A has a circular cross-section of radius r and wire B has a square cross-section of side a such that their cross-sectional areas are equal (πr² = a²). Under the same tensile force:

* (a) Both have the same elongation
* (b) A elongates more than B
* (c) B elongates more than A
* (d) The ratio of their elongations equals the ratio of their areas

---

**Q32.** A wire of cross-sectional area A and Young's modulus Y is fixed at both ends. The temperature is decreased by ΔT. If the coefficient of linear expansion is α, the force developed in the wire is:
...
**Q33.** A block of rubber has Young's modulus Y and Poisson's ratio ν = 0.5. When compressed, its volume:
...
**Q34.** A uniform rod of cross-sectional area A, length L, Young's modulus Y, and density ρ hangs vertically under its own weight. The total elastic potential energy stored in the rod is:
...
**Q35.** The relationship between Young's modulus (Y), Bulk modulus (B), and Poisson's ratio (ν) is:
...
**Q36.** A wire of length L₀ is extended by ΔL. If the wire has Poisson's ratio ν and original radius r₀, the change in the volume of the wire is approximately:
...
**Q38.** A wire of cross-section A, length L, and Young's modulus Y is compressed by Δl by a force F. The energy stored in the wire is:
...
**Q39.** For a material with Y = 200 GPa, G = 80 GPa, the value of Poisson's ratio ν is:
...
**Q40.** A cylindrical rod of length L and radius R is subjected to a compressive force F along its length. Given Poisson's ratio ν and Young's modulus Y, the increase in radius ΔR is:
...
**Instructions:** Both Assertion (A) and Reason (R) are given. Choose:
...
**Reason (R):** Steel has a larger Young's modulus than rubber.

---

**Q42.** 🟢
**Assertion (A):** Shearing stress is possible only in solids.
**Reason (R):** Liquids and gases do not have a definite shape and cannot resist tangential forces.

---

**Q43.** 🟡
**Assertion (A):** The bulk modulus of a gas is very much smaller than that of a solid.
**Reason (R):** Solids have tightly packed atoms; gases have very weakly coupled molecules.

---

**Q44.** 🟡
**Assertion (A):** Bridges and beams are designed with I-shaped cross-sections.
**Reason (R):** The I-shape maximises depth (minimising sag) while flanges prevent lateral buckling, reducing material while maintaining strength.
...
**Q46.** 🟡
**Assertion (A):** Poisson's ratio is a dimensionless quantity.
**Reason (R):** Poisson's ratio is the ratio of two strains, each of which is dimensionless.

---

**Q47.** 🟡
**Assertion (A):** The proportional limit and elastic limit are the same point on the stress-strain curve.
**Reason (R):** Hooke's law is valid throughout the elastic region.
...
# PART C: CASE-BASED / IMAGE-BASED QUESTIONS ⭐

## Case 1 — Stress-Strain Curve Analysis 🟢🟡

**Passage:** The graph below describes the stress-strain curve of a metallic wire under tensile stress. Key points are labelled O, A, B, C, D, and E.
...
**Q51.** 🟢 In the region O to A, the slope of the graph equals:
...
**Q52.** 🟢 If the load is removed when the stress corresponds to point C on the curve, the wire will:

* (a) Completely recover its original length
* (b) Not recover at all
* (c) Recover partially, retaining a permanent set
* (d) Fracture immediately

---

**Q53.** 🟡 Which region of the curve is ELASTIC but NOT Hookean?
...
**Q54.** 🟡 The material is said to be brittle if:

* (a) The region O to A is very long
* (b) The yield strength is very high
* (c) Points D and E are very close together
* (d) Points D and E are far apart

---

**Q55.** 🟡 For an elastomer (like rubber), compared to the curve shown for a metal, the stress-strain curve would show:

* (a) A shorter elastic region and a longer plastic region
* (b) A longer, non-linear elastic region and no clear plastic region
* (c) A linear elastic region extending to very large strains
* (d) A flat curve at all strains
...
## Case 2 — Elastic Moduli and Material Selection 🟡
...
| Rubber | ~0.01 | ~0.003 | ~2.0 | ~30 |

---

**Q56.** 🟡 The most relevant modulus for Application P (rope for lifting) is:

* (a) Shear modulus G
* (b) Bulk modulus B
* (c) Young's modulus Y and yield strength
* (d) Poisson's ratio ν

---

**Q57.** 🟡 The most relevant modulus for Application Q (ocean component) is:
...
**Q58.** 🟡 For Application R (floor beam), which material would produce the LEAST sag for the same beam geometry and load?
...
**Q59.** 🟡 Steel ropes are always braided (many thin wires) rather than being a single thick wire of the same area. The primary engineering reason is:

* (a) Braided wires have a higher Young's modulus
* (b) A single thick wire would be too rigid and inflexible for practical use
* (c) Braided wires are cheaper to manufacture
* (d) Braided wires have better corrosion resistance
...
**Q61.** 🟢 The mass supported by the base performer's legs is:
...
**Q62.** 🟢 The force on each thighbone is approximately:
...
**Q63.** 🟡 The cross-sectional area of each thighbone is approximately:
...
**Q64.** 🟡 The compression in each thighbone (ΔL) is approximately:
...
**Q65.** 🟡 The fractional compression (ΔL/L) expressed as a percentage is approximately:
...
**Q66.** 🟡 The area of the face on which the shearing force acts is:
...
**Q67.** 🟡 The shearing stress on the slab is:
...
**Q68.** 🟡 The shearing strain produced is:
...
**Q69.** 🟡 The displacement of the upper edge relative to the lower edge is:
...
| 70 | (a) | Δx ∝ 1/G; G_Cu/G_Pb = 42/5.6 = 7.5; so Δx_Cu = Δx_Pb / 7.5; factor = 1/7.5 |
...
*Total Questions: 80 | End of Question Bank — Physics Ch. 8*